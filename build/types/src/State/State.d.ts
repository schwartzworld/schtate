...
export declare class State<Something> implements Schtate<Something> {
    ...
    map<SomethingElse>(cb: (arg: Something) => SomethingElse): State<SomethingElse>;
    reduce<SomethingElse>(cb: (arg0: SomethingElse, arg1: Something) => SomethingElse, starterThing: SomethingElse): State<SomethingElse>;
